...
Inductive Reasoning
What philosophers call enumerative induction is the following kind of inference (F is a noun, G an adjective)
	
	I’ve seen lots of Fs and they’ve all been Gs
	––––––––––––––––––––––––––––
	So the next F I see will be G
Inductive Reasoning
This kind of argument is not valid
But it can be perfectly reasonable
When can it be used?
When I’ve seen lots of Fs
When I’ve seen them in a wide variety of situations
When F and G are real features of the world
Inductive Reasoning
When cases are exactly alike, or we have little data, we can’t use that method
But we might be able to reason by analogy  with past cases
The idea is that situations that are alike in some respects are alike in other respects
Arguments by Analogy
Inferring same culprit from same style of crime
Inferring circulation of blood in other creatures from it happening in humans
Inferring others have pains from the fact that we have pains
These arguments might work even with small base
Arguments by Analogy
These arguments are strongest when they are explicitly causal
Non-causal arguments by analogy often look fairly dubious
E.g. The last world war started on a Tuesday, so by analogy the next world war will probably start on a Tuesday
Unless Tuesday is causally relevant
Argument by Analogy
In general the slogan here is  	Similar Causes, Similar Effects 
And vice versa
Inference to the Best Explanation
Imagine that we are detectives investigating a murder
There are two suspects X and Y; only they had access to the murder weapon
X had a strong motive to kill the victim
Y liked the victim, and had no motive
We infer that X was likely the killer
Inference to the Best Explanation
The reason for this is that if X is the killer, we could explain what happened
If Y was the killer, it would be inexplicable
In general, we adopt hypotheses that make our data explicable
This is called inference to the best explanation
Design Argument
...
Artifacts that serve a purpose are designed
The universe serves a purpose
So by analogy to these artifacts it is designed

Design Argument (Analogy)
This doesn’t quite get us God
We can get a bit closer to God’s existence with a trivial step
...
Four Objections
Weak analogy
The universe is not like artifacts
Regress
Who designed God?
Nature of God
This doesn’t establish God’s goodness
Alternative explanations
The universe could have ‘generated’
Design Argument
...
Design Argument
Hume’s primary focus is the analogy
...
Since designers we see are human, by analogy God is similar  to humans
Demea’s Objections
Compare: man was made in God’s image
Surprisingly, Demea is strongly opposed to this conclusion
God is infinite and not at all like humans
Demea’s Objections
This argument gives us a probability that God exists, not a certainty
The latter point is clearly correct
But we shouldn’t make too much of it
It’s only probable in Demea’s sense that the snow in the quad is cold
Kind of Designer
Philo’s also objects to the analogy to humans
