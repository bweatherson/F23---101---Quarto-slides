...
### <https://join.iclicker.com/PSPL> 

- If you already have an iClicker account, do not create a new account. iClicker will attempt to find your account for you.
- If an account is found: Enter your existing iClicker password. Select “Link Accounts” to complete setup. 
- If you have an iClicker account under a different email: Select “Yes”  and enter your account information to update your account.
- If you do not have an iClicker account: Select “No,” then select “Create Account.” An account will be set up for you. **Use your UM email to set this up, so that it will know you are covered under UM's subscription**.
...
Keep going with Magnus's book.

Next up, we'll look at some important patterns of valid and invalid arguments, which are covered in chapter 2.
