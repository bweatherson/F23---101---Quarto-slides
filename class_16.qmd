...
We don't have iClicker today because apparently it's not working through the podium computers.

Hopefully it will be back by Thursday.
...
**A**: We know God doesn’t exist because He has never intervened on earth.

**T**:	What about giving Moses the Ten Commandments?

**A**:	We know that wasn’t God, because God doesn’t exist.
...
We don’t know how an immaterial deity could have produced a material universe. 

## Growth and IBE

This issue, about immaterial things and material things could possibly interact, was one of the biggest philosophical issues of the day, because it's tied up with questions about how human minds work.
...
The multiverse hypothesis is an explanation of why the laws of the universe are 'fine-tuned' for life. This is a big topic in contemporary philosophy/physics/astronomy. Or, perhaps better, there are three big topics here.

1. Is the universe really fine-tuned for life?
2. If so, does this fact need an explanation?
3. If so, is the multiverse a good explanation? Or, is the existence of a designer (or designers) a good explanation?

---

![For more on this, see the Stanford Encyclopedia of Philosophy entry on fine-tuning](images/16/sep-fine-tuning.png){height=650}

## Cleanthes's Reply

In objecting to this, Cleanthes makes a rather remarkable objection.
...
The reason this is not a popular objection to Darwinism should be clear.
...
While we’re doing history, note a very surprising discussion in Part XI. (This is a side note to what we'll actually discuss in XI, so I'm noting it here.)
...
We'll discuss one of the arguments *against* belief in God, the Problem of Evil.