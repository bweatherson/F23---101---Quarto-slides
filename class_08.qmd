...
- Russell has three distinctive features of this theory of induction: he gives **laws**, **probability**, and **enumerative induction** special places.
- I'll end with several questions you might have about this account.
...
1. Are laws so central to induction? An alternative view is that we learn laws by first learning non-law generalisations.
2. Does induction ever yield knowledge of non-probabilistic things?
3. Does induction ever yield even probability of universal generalisations? If all we know of each F is that it is probably G, how can we know that probably all Fs are Gs?
4. Is enumerative induction as central as Russell makes it out to be?
5. Russell doesn't mention variety of instances. Is this an oversight, or a serious mistake?
6. Might these last two things be related? Maybe other things can explain the importance of variety.
