...
1. You'd only believe the premises if you (already) believed the conclusion; 
2. You'd only believe that premises support conclusion if you (already) believed the conclusion. 
