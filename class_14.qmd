...
I'm going to mostly still be talking about Part II.

But at the end we'll get to Cleanthes's replies in Part III.

---

<center>

![A brief summary of the argument.](argdown/design.png){height=600}
...
It's worth noting that (a) Hume is writing a century before Darwin, and (b) he sometimes writes as if Design Argument (Analogy) is the real form of the design argument.
...
But knowing why a few friends chose Michigan will be very little help in figuring out why students chose Ohio State.
...
Which of them brings up the example of the "voice were heard in the clouds, much louder and more melodious than any which human art could ever reach"?

A.  Cleanthes
B.  Demea
C.  Philo
D.  None of them, it's not in the book.
...
Cleanthes is making a very important kind of philosophical move here: an **overgeneration** argument.

Overgeneration arguments are when you take someone's reasoning, and show that the same reasoning would work to show something actually wrong.

## Overgeneration

1. After hearing the Divine Voice, all of Philo's premises would still be true.
2. After hearing the Divine Voice, Philo's conclusion would be false.
3. So, Philo's reasoning is faulty.
4. So, Philo's reasoning doesn't work _even in the world where we haven't heard the Divine Voice_.
...
![Philo needs to find some things he can retract if the Divine Voice appears.](argdown/design.png){height=600}
